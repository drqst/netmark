use crate::core::{
    Config, DEFAULT_REMOTE, Metrics, PACKET_SIZE, PacketType, SqlState, StartGate, database_path,
    send_tcp_packets, spawn_client, spawn_server, timestamp,
};
...
fn traffic_config_round_trips_through_yaml() {
    ...
    assert_eq!(parsed.traffic.rate, 42);
